...
const Art = () => {
    ...
    useGSAP(() => {
        ...
        maskedTimeline
            .to('.will-fade', {opacity: 0, stagger: .02, ease: 'power1.inOut'})
            ...
            <div className="container mx-auto h-full pt-20">
                ...
                <div className='masked-container'>
                    ...
                    <div id="masked-content">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus exercitationem non qui id. Soluta, recusandae.</p>
                    </div>
                </div>
            </div>
        </div>
